    ...
    public class NetworkEventDebugger : MonoBehaviour
    {
        ...
        private void PublishToLocalEventBus(EventCode code, object dtoPayload)
        {
            ...
            switch (code)
            {
                ...
                case EventCode.CardVisibilityChanged:
                    bus.Publish(_converter.ToDomain((Tetrage.Network.Gameplay.CardStateChangedEvent)dtoPayload));
                    break;
        ...
        private Type GetTypeForEventCode(EventCode code)
        {
            return code switch
            {
                ...
                EventCode.CardVisibilityChanged => typeof(Tetrage.Network.Gameplay.CardStateChangedEvent),
